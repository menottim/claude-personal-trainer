...
| Taper before competition (volume reduced 41-60% over ~2 weeks, intensity maintained) produces small but real ~3-4% performance gains. 2-4 days of training cessation can enhance maximal strength. | Strong (meta-analysis + narrative reviews) | Bosquet et al. 2007; Pritchard et al. 2015 |
...
1. __Weekly set targets by muscle group__ (in-season, balancing sport load):
   - __Lower-body compound patterns__ (squat/hinge): 6-10 hard sets/week across all lifting sessions combined.
   - __Upper push__: 8-12 sets/week (BB bench primary + DB bench accessory + OHP).
   - __Upper pull__: 8-12 sets/week (lat pulldown + rows).
   - __Calves (Achilles HSR if applicable)__: 3-4 sets, 3x/week of heavy slow resistance per Beyer protocol.
...
2. __Last-lift-of-the-week cut rule.__ If by the final lifting session of the week cumulative sRPE is elevated or lower-body DOMS is present, cut to 2 main lifts at top-set only, RPE ≤7, no accessory work. Baker's rugby data supports minimal-volume in-season maintenance when fatigue is present.
...
4. __RPE targets by phase:__
   - __Foundation phases__: main lifts at RPE 7-8 (2-3 RIR), accessories at RPE 8.
   - __Strength-Power phases__: main lifts at RPE 8 (2 RIR), plyos at RPE 6-7.
...
5. __48-hour game-proximity buffer.__ Avoid heavy lower-body lifting within 48 hours of a competition or high-intensity game. The lifting session immediately preceding game day should stay at RPE ≤7 and skip high-impact plyometrics. Bosquet taper literature supports 2-4 day pre-competition cessation for maximal neuromuscular output.
...
For any in-season athlete balancing concurrent strength training and sport: target 6-10 hard sets per muscle per week from lifting; use RPE/RIR auto-regulation rather than fixed %1RM; protect a 48-hour gap between heavy lower-body work and games; deload reactively based on measurable fatigue markers, not on a fixed calendar; minimum-effective-dose research means brief in-season blocks at high effort beat skipping the gym.
...
- __2026-04-18:__ File initialized. Corrections to prior claims in the user's `CLAUDE.md`:
